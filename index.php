...
<head>
    ...
    <title>KaBot</title>
    <meta name="description" content="Binggung Cari Bot? Ya Disini Aja. KaBot Hadir Untuk Membantu Anda">
    <link href='asset/img/bot.png' rel='apple-touch-icon' type='image/png'>
    <link href='asset/img/bot.png' rel='apple-touch-startup-image'>
    <link rel="shortcut icon" href="asset/img/bot.png" type="image/x-icon">
    ...
    <style>
        ...
        @font-face {
            ...
            src: url(asset/font/kindergarten.ttf);
        }

        @font-face {
            font-family: alexross;
            src: url(asset/font/Alexross-Regular.ttf);
        }

        @font-face {
            font-family: Calligraphy;
            src: url(asset/font/Calligraphy.ttf);
        }

        @font-face {
            font-family: Badhandwriting;
            src: url(asset/font/Badhandwriting.ttf);
        }
                ...
                <div id="navbarBasicExample" class="navbar-menu">
                    ...
                    <div class="navbar-end">
                        <div class="navbar-item">
                            <div class="buttons">
                                <a class="button is-link has-text-white has-text-weight-bold" href="https://wa.me/?text=*Link KaBot :*%0A<?= "https://" . $_SERVER['HTTP_HOST']  . $_SERVER['PHP_SELF']; ?>" title="Berbagi" target="_blank">
