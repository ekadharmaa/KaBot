                                        ...
                                        <div class="control">
                                            <div class="select">
                                                <select id="font" onchange="IsiFont()" name="font" required>
                                                    ...
                                                    <option value="Kindergarten" <?= $font == "Kindergarten" ? 'selected' : '' ?>>Kindergarten</option>
                                                    <option value="alexross" <?= $font == "alexross" ? 'selected' : '' ?>>Alexross</option>
                                                    <option value="Calligraphy" <?= $font == "Calligraphy" ? 'selected' : '' ?>>Calligraphy</option>
                                                    <option value="Badhandwriting" <?= $font == "Badhandwriting" ? 'selected' : '' ?>>Badhandwriting</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
